package com.co.taller2.serviceshowtime.controller;

import com.co.taller2.serviceshowtime.entities.ShowTime;
import com.co.taller2.serviceshowtime.service.ShowTimeService;
...
public class ShowTimeController {
    ...
    @GetMapping(value = "/{id}")
    public ResponseEntity<ShowTime> getShowTime(@PathVariable("id") Long idShowTime) {
